  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative h-[70vh] md:h-[80vh] lg:h-[100vh] overflow-hidden">
        ...
        {/* Text Content */}
        <div className="relative z-10 flex items-center h-full px-6 md:px-16 text-left">
          <div className="max-w-xl pl-6 md:pl-12">
            <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold text-white mb-4 pl-10">
              Opportunities Makers
            </h1>
            <p className="text-base sm:text-lg md:text-2xl text-white/90 pl-10">
      ...
      {/* Webinar Section */}
      <div className="flex bg-primary/80 backdrop-blur-md border rounded-3xl py-6 px-8 text-white lg:w-[60%] mt-10 mx-auto shadow-lg transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl relative flex-col md:flex-row">
        <div className="animate-fadeIn flex-1">
          ...
          {/* Row 1: Date + Speaker */}
          <div className="flex gap-8 mb-16 flex-col sm:flex-row">
          ...
          <div className="absolute bottom-2 left-1">
            <button
              onClick={() =>
                window.open("https://zoom.us/your-session-link", "_blank")
              }
